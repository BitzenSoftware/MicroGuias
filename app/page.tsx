...
export default async function HomePage() {
  ...
  return (
    <div className="space-y-10">
      {/* Hero */}
      <section className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-indigo-600 via-indigo-500 to-purple-600 px-6 sm:px-10 py-10 sm:py-12 text-white">
        {/* Blobs decorativos */}
        ...
        <div className="relative grid items-center gap-8 md:grid-cols-2">
          ...
          <div className="text-center md:text-left">
            ...
            <p className="mt-4 max-w-md text-lg text-indigo-100 md:mx-0 mx-auto">
            ...
            <div className="mt-6 flex flex-wrap items-center justify-center md:justify-start gap-x-5 gap-y-2 text-sm text-indigo-100/90">
